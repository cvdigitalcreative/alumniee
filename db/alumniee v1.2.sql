...
INSERT INTO `campaign` (`campaign_id`, `nama_pekerjaan`, `url`, `companyd`, `roledc`, `salary`, `ipk`, `jenis_pekerjaan`, `lokasi`, `jurusan`, `bahasa`, `skillLanguage`, `skillDatabase`, `skillFramework`, `question`, `company_id`) VALUES
(7, '12', 'dad', '2e', 'e2e', '1000000', '2', 'Hardware Engineer;', 'Banda Aceh;', 'Sistem Komputer;', 'English;', 'C;', 'MySQL;', 'Android;', 'ad;', 1),
(8, '1', 'ddw', 'ada', 'ad', '1000000', '2', 'Hardware Engineer;', 'Banda Aceh;Pangkal Pinang;', 'Sistem Komputer;', 'English;', 'C++;', 'MySQL;', 'Android;', 'asdada;', 1),
(9, 'Cari orang IT', 'wdada', 'dasda', 'dasda', '4000000', '3', 'Software Engineer;IT Support;', 'Padang;Palembang;Jakarta;Bandung;', 'Teknik Informatika;', 'English;', 'Java;PHP, HTML, CSS;', 'MySQL;', 'CodeIgniter;React;', 'adasd;asda;', 1);
