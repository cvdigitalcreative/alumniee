...
INSERT INTO `broadcast_campaign` (`bc_id`, `campaign_id`, `talent_id`, `matching_persentase`, `status`) VALUES
(1, 7, 2, 71, 1),
(2, 7, 1, 57, 1),
(3, 7, 3, 32, 2),
(4, 8, 1, 100, 1),
...
INSERT INTO `campaign` (`campaign_id`, `campaign_status`, `nama_pekerjaan`, `url`, `companyd`, `roledc`, `salary`, `ipk`, `jenis_pekerjaan`, `lokasi`, `jurusan`, `bahasa`, `skillLanguage`, `skillDatabase`, `skillFramework`, `question`, `company_id`) VALUES
(7, 0, '12', 'dad', '2e', 'e2e', '1000000', '2', 'Hardware Engineer;', 'Banda Aceh;', 'Sistem Komputer;', 'English;', 'C;', 'MySQL;', 'Android;', 'ad;', 1),
(8, 0, '1', 'ddw', 'ada', 'ad', '1000000', '2', 'Hardware Engineer;', 'Banda Aceh;Pangkal Pinang;', 'Sistem Komputer;', 'English;', 'C++;', 'MySQL;', 'Android;', 'asdada;', 1),
(9, 1, 'Cari orang IT', 'wdada', 'dasda', 'dasda', '4000000', '3', 'Software Engineer;IT Support;', 'Padang;Palembang;Jakarta;Bandung;', 'Teknik Informatika;', 'English;', 'Java;PHP, HTML, CSS;', 'MySQL;', 'CodeIgniter;React;', 'adasd;asda;', 1);
...
--
ALTER TABLE `broadcast_campaign`
  MODIFY `bc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
